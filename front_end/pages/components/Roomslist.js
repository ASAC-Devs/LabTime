...
export default function AvailableRoom(props) {
    ...
    return (<>
        ...
        <section className="col-span-1 col-start-1 row-span-5 row-start-1 p-2 overflow-y-scroll rounded-lg shadow-inner h-my w-52 bg-gradient-to-b from-green-light/70 to-blue-dark/70">
